...
public sealed class SourceGeneratorSmokeTests
{
    ...
    public void Generator_emits_default_projection_hook_support_declarations()
    {
        ...
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldContain("Supplies the rewrite markers that generated selectors can use");
        ...
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldContain("/// <param name=\"value\">The source value or navigation member that should participate in the requested rewrite.</param>");
        generatedSources["Linqraft.Declarations.g.cs"]
        ...
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldContain("internal sealed class LinqraftQuery<TIn>");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldContain("internal sealed class LinqraftEnumerable<TIn>");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldContain("internal sealed partial class LinqraftAutoGeneratedDtoAttribute");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldContain("[global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldContain(
        ...
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldNotContain("using System.Collections.Generic;");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldNotContain("using System.Linq;");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldNotContain("AsLeftJoinExtensions");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldNotContain("AsInnerJoinExtensions");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldNotContain("public static T Generate<T>(object x, object capture)");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldNotContain("public static global::System.Linq.IQueryable<TResult> SelectManyExpr<TIn, TResult>(this global::System.Linq.IQueryable<TIn> query, global::System.Func<TIn, global::System.Collections.Generic.IEnumerable<TResult>> selector, object capture) where TIn : class");
        generatedSources["Linqraft.Declarations.g.cs"]
            .ShouldNotContain("public static global::System.Linq.IQueryable<TResult> GroupByExpr<TIn, TKey, TResult>(this global::System.Linq.IQueryable<TIn> query, global::System.Func<TIn, TKey> keySelector, global::System.Func<global::System.Linq.IGrouping<TKey, TIn>, TResult> selector, object capture) where TIn : class");
    }
