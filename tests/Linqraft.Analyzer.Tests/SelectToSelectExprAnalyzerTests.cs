...
class TestClass
{
    void TestMethod()
    {
        ...
        var expectedAfterFix = new DiagnosticResult(DiagnosticDescriptors.EnhanceSelectExpr)
            .WithLocation(1);
...
class TestClass
{
    void TestMethod()
    {
        ...
        test.FixedState.AnalyzerConfigFiles.Add(("/.editorconfig", "[*.cs]\ndotnet_diagnostic.LQ002.severity = none"));
        test.CompilerDiagnostics = CompilerDiagnostics.None;
