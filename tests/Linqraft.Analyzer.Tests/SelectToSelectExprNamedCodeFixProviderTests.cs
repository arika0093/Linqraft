...
class Test
{
    ...
    [Fact]
    public async Task CodeFix_Explicit_AddsCapture_WhenLocalVariableIsUsed_WithChainedMethod()
    {
...
class Test
{
    ...
    [Fact]
    public async Task CodeFix_Predefined_AddsCapture_WhenLocalVariableIsUsed_WithChainedMethod()
    {
        // This test case reproduces the bug described in the issue:
        // When converting .Select(...).FirstOrDefault() to SelectExpr,
        // the capture parameter should be added to SelectExpr, not to FirstOrDefault.
