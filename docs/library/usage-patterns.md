...
| [Projection Hooks](./projection-hooks.md) | Rewritten selector fragments | Opt into helper-driven `AsLeftJoin`, `AsInnerJoin`, `AsProjection`, `Project(...).Select(...)`, and `AsProjectable` rewrites inside generated projections |
