...
| [Projection Hooks](./projection-hooks.md) | Rewritten selector fragments | Opt into helper-driven `AsLeftJoin` / `AsProjectable` rewrites inside generated projections |
