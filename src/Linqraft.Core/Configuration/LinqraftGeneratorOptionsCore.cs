...
public abstract class LinqraftGeneratorOptionsCore
{
    ...
    /// <summary>
    /// Gets the generated abstract base type name for reusable mapping declarations.
    /// Return <see langword="null"/> to omit the base type and disable class-based mapping declarations.
    /// </summary>
