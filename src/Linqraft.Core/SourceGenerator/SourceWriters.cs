...
internal static class SourceWriters
{
    ...
    public static string WriteMappingUnit(MappingRequest request, LinqraftConfiguration configuration)
    {
        var builder = CreateFileBuilder(configuration);
    ...
    )
    {
        ...
        switch (source)
        {
            case ProjectionOwnedGeneratedSourceModel projection:
                WriteInterceptorDeclaration(builder, projection.Request, configuration.GeneratorOptions);
                break;
    ...
    public static string WriteGlobalUsingsUnit(LinqraftConfiguration configuration)
    {
        var builder = new IndentedStringBuilder();
        builder.AppendLines(
            $$"""
            {{CodeTemplateContents.CreateAutoGeneratedHeader(configuration.GeneratorOptions.GeneratedHeaderComment)}}
            #nullable enable
    ...
    private static IndentedStringBuilder CreateFileBuilder(LinqraftConfiguration configuration)
    {
        var builder = new IndentedStringBuilder();
        builder.AppendLines(
            $$"""
