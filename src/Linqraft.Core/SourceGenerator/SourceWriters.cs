...
internal static class SourceWriters
{
    ...
    )
    {
        ...
        {
            builder.AppendLine(CodeTemplateContents.EditorBrowsableNeverAttribute, cancellationToken);
    ...
    )
    {
        ...
        using (builder.Indent())
        {
            ...
            using (builder.Indent())
            {
                ...
                {
                    builder.AppendLine($"return source.Select({expressionFieldName});", cancellationToken);
                }
                else
                {
                    AppendMultilineLine(
    ...
    {
        return GeneratedSourceFormatter.FormatGeneratedSource(builder.ToString(), cancellationToken);
    }
