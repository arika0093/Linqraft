...
public static class GenerateSourceCodeSnippets
{
    ...
    )
    {
        ...
        context.AddSource(
            "LinqraftReverseConvertionAttribute.g.cs",
            LinqraftReverseConvertionAttribute
        );
    }
    ...
    /// <summary>
    /// Attribute to trigger reverse conversion generation for DTOs.
    /// Applied to a converter class, targeting the DTO type to reverse.
    /// </summary>
    [StringSyntax("csharp")]
    public const string LinqraftReverseConvertionAttribute = $$"""
        {{CommentHeaderPartOnProd}}
        #nullable enable
        using System;
        using Microsoft.CodeAnalysis;
