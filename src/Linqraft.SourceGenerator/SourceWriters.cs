...
internal static class SourceWriters
{
    ...
    )
    {
        ...
        WriteDebugOriginComments(builder, dto.Origins);
    ...
    )
    {
        ...
        using (builder.Indent())
        {
            ...
            using (builder.Indent())
            {
                ...
                WriteDebugOriginComment(builder, request.Origin);
                if (
    ...
    private static void WriteDebugOriginComment(
        IndentedStringBuilder builder,
        GeneratedSourceOriginModel origin
    )
    {
#if DEBUG
        builder.AppendLine($"// Source: {origin.FileName}:{origin.LineNumber}");
#endif
    }

    private static void WriteDebugOriginComments(
        IndentedStringBuilder builder,
        IEnumerable<GeneratedSourceOriginModel> origins
    )
    {
#if DEBUG
        foreach (var origin in origins)
        {
            WriteDebugOriginComment(builder, origin);
        }
#endif
    }
