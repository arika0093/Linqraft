...
public class AutoGeneratedDtoUsageAnalyzer : BaseLinqraftAnalyzer
{
    ...
    /// <summary>
    /// The fully qualified name of the attribute that marks auto-generated DTOs.
    /// </summary>
    private const string AutoGeneratedAttributeFullName = "Linqraft.LinqraftAutoGeneratedDtoAttribute";
    ...
    private static bool HasAutoGeneratedDtoAttribute(ITypeSymbol type)
    {
        ...
        return type.GetAttributes().Any(attr =>
        {
            ...
            // Check by fully qualified name
            var fullName = attrClass.ToDisplayString();
            return fullName == AutoGeneratedAttributeFullName;
        });
    }
