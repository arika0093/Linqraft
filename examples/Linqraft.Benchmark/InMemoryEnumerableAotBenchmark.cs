...
public partial class InMemoryEnumerableAotBenchmark
{
    ...
    // ============================================================
    // Pattern 4: Linqraft UseLinqraft()
    // .Select with Auto-Generated DTO
    ...
    public int Linqraft_AutoGeneratedDto()
    {
        var results = _data
            .UseLinqraft()
            .Select<InMemoryEnumerableAotLinqraftSampleClassDto>(s => new
            {
                s.Id,
                s.Foo,
                s.Bar,
    ...
    // ============================================================
    // Pattern 5: Linqraft UseLinqraft()
    // .Select with Manual DTO
