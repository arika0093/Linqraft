...
<div align="center">
  ...
  Write Select, GroupBy, and SelectMany projections easily with on-demand DTO generation and null-propagation operators. No dependencies.
</div>
...
* **Query-based** automatic DTO generation
  ...
  * Includes `GroupByExpr` and `SelectManyExpr` helpers built on the same projection engine.
