...
public class CodeGenerationService
{
    ...
    /// Removes EditorBrowsable and LinqraftAutoGeneratedDtoAttribute lines.
    /// </summary>
    private static string FilterInternalAttributes(string dtoCode)
    {
        var lines = dtoCode.Split('\n');
        var filteredLines = lines.Where(line =>
        {
            var trimmed = line.Trim();
            // Skip lines containing internal attributes
            return !trimmed.StartsWith("[global::System.ComponentModel.EditorBrowsable")
                && !trimmed.StartsWith("[Linqraft.LinqraftAutoGeneratedDtoAttribute]");
        });
        return string.Join("\n", filteredLines);
    }
